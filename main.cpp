...
__kernel void float_func(__global const float* in, __global float* out)
{
        ...
        for (int i = 0; i < 10000; ++i) {
                out[tid] += (in[tid * 3] * in[tid * 3 + 1] + in[tid * 3 + 2]) / 127.0f;
        }
}
Info:
__kernel void double_func(__global const double* in, __global double* out)
{
        ...
        out[tid] = 0;
        for (int i = 0; i < 10000; ++i) {
                out[tid] += (in[tid * 3] * in[tid * 3 + 1] + in[tid * 3 + 2]) / 127.0;
        }
}
...
Info: Time between queued and submit: 107840
Info: Time between submit and start: 25920
Info: Time between start and end: 2022400
Info: Platform 1
...
Info: Successfully create command queue.
Info: Successfully enqueue kernel.
Info: Time between queued and submit: 252200
Info: Time between submit and start: 3684133
Info: Time between start and end: 1969833
Info: Device 1
...
Info: Successfully create command queue.
Info: Successfully enqueue kernel.
Info: Time between queued and submit: 1700
Info: Time between submit and start: 2228700
Info: Time between start and end: 2914200
*/
// Test double result:
/*
Info: Successfully get platforms.
...
Info: Successfully create command queue.
Info: Successfully enqueue kernel.
Info: Time between queued and submit: 117184
Info: Time between submit and start: 25856
Info: Time between start and end: 9116672
Info: Platform 1
Info: The name of platform is: Intel(R) OpenCL
Info: The vendor of platform is: Intel(R) Corporation
Info: The version of platform is: OpenCL 2.1
...
Info: Successfully create command queue.
Info: Successfully enqueue kernel.
Info: Time between queued and submit: 226000
Info: Time between submit and start: 1543750
Info: Time between start and end: 14400250
Info: Device 1
Info: The name of device is: Intel(R) Core(TM) i7-8565U CPU @ 1.80GHz
Info: The vendor of device is: Intel(R) Corporation
Info: The version of device is: OpenCL 2.1 (Build 0)
...
Info: Successfully create command queue.
Info: Successfully enqueue kernel.
Info: Time between queued and submit: 1400
Info: Time between submit and start: 3409900
Info: Time between start and end: 2257200
*/